...
IF OBJECT_ID('USP_GET_TRABAJADOR','P') IS NOT NULL
	DROP TRIGGER USP_GET_TRABAJADOR
GO
...
IF OBJECT_ID('USP_GET_TRABAJADORES','P') IS NOT NULL
	DROP TRIGGER USP_GET_TRABAJADORES
GO

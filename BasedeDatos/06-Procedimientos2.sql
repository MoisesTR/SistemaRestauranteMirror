...
END
GO
IF OBJECT_ID('TG_ENTRADA_PRODUCTO_BODEGA_AREA_PRODUCCION','TR') IS NOT NULL
	DROP TRIGGER TG_ENTRADA_PRODUCTO_BODEGA_AREA_PRODUCCION
GO
CREATE TRIGGER TG_ENTRADA_PRODUCTO_BODEGA_AREA_PRODUCCION
ON DETALLE_ENTRADA_BODEGA_AREA_PRODUCCION
FOR INSERT
AS BEGIN
 INSERT INTO DETALLE_BODEGA_AP(IdBodegaAreaP,IdDetalleEntradaAP,IdEntradaBodegaAP,IdProductoProveedor,IdEstadoEmpaque,Cantidad,FechaHoraIngreso)
 SELECT EB.IdBodegaAreaP,I.IdDetalleEntradaAP,I.IdEntradaBodegaAP,IdProductoProveedor,dbo.UFN_CHECK_ESTADO_EMPAQUE(IdProductoProveedor,I.Cantidad),I.Cantidad,FechaHora FROM inserted I INNER JOIN ENTRADA_BODEGA_AREA_PRODUCCION EB
 ON I.IdEntradaBodegaAP = EB.IdEntradaBodegaAP
END
GO
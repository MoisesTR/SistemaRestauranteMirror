...
export class SubClasificacionProductoService {
	...
	createSubClasificacionProducto(Subclasificacion): Observable<any> {
		...
		return this._http.post(this.url + "subclasificacion", params, {
			headers: headers
		});
	}
	...
	getSubClasificaciones(Habilitado = 1): Observable<any> {
		return this._http.get(
			this.url + "subclasificaciones?Habilitado=" + Habilitado
		);
	}
	...
	updateSubClasificacionProducto(
		...
		return this._http.put(
			this.url + "subclasificacion/" + SubClasificacion.IdSubClasificacion,
			params,
			{ headers: headers }
		);
	}
	...
	deleteSubclasificacion(IdSubClasificacion): Observable<any> {
		...
		return this._http.request(
			"delete",
			this.url + "subclasificacion/" + IdSubClasificacion,
